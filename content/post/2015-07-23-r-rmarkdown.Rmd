...
Die nächste Definition geht zurück auf die alten Griechen um Sokrates und den von Ihnen eingeführten Begriff der Logik, also der rationalen Schlussfolgerung. Für KI bedeutet das, dass wir von Intelligenz sprechen, wenn der Computer für ein gegebenes Problem die "richtige" Schlussfolgerung zieht. Wie du hier sehen kannst, verwendet diese Definition jetzt nicht mehr explizit den Menschen als Referenz für Intelligenz, sondern steht unter der Maxime der Rationalität. Da sich Menschen nicht unbedingt immer rational verhalten (siehe zum Beispiel das sehr gute populärwissenschaftliche Buch "Schnelles und Langsames Denken" von Daniel Kahnemann), kann sich der Computer hier, wenn es ein muss, anders verhalten als ein Mensch.
...
Intelligenz bedeutet hier, bei einem gegebenen Problem die optimale Handlung, oder zumindest bestmögliche Handlung, zur Lösung des Problems auch wirklich auszuführen. Dies beinhaltet natürlich oft rationales Denken, da man die Lösung erst kennen muss, bevor man sie ausführen kann. Diese Definition beinhaltet aber noch viel mehr! So kann zum Beispiel der Computer hier auch dann handeln, wenn mehrere Lösungen richtig erscheinen, oder es keine objektiv richtige Lösung gibt, jedoch eine Handlung unbedingt ausgeführt werden muss. Stell dir z.B. vor, du sollst dich innerhalb von fünf Minuten zwischen 1000 verscheidenen Autos entscheiden. In diesem kurzen Zeitraum kannst du nicht rational zwischen allen möglichen Alternativen abwägen, sondern musst die bestmögliche Entscheidung treffen, die du in fünf Minuten fällen kannst. 
